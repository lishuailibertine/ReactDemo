  ...
  "src/icons/Photo.tsx"() {
    ...
    Photo = (allProps) => {
      ...
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
          icon: /* @__PURE__ */ React36__namespace.createElement(
            "svg",
            {
              width: "100%",
              height: "100%",
...
var PhotoDrag;
var init_PhotoDrag = __esm({
  "src/icons/PhotoDrag.tsx"() {
    init_IconWrapper();
    PhotoDrag = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var GridAlt;
var init_GridAlt = __esm({
  "src/icons/GridAlt.tsx"() {
    init_IconWrapper();
    GridAlt = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
      ...
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
          icon: /* @__PURE__ */ React36__namespace.createElement(
            ...
            /* @__PURE__ */ React36__namespace.createElement("path", { d: "M4 5.5a.5.5 0 000 1h4a.5.5 0 000-1H4z", fill: "currentColor" }),
            /* @__PURE__ */ React36__namespace.createElement(
              "path",
              {
                fillRule: "evenodd",
...
var ZoomReset;
var init_ZoomReset = __esm({
  "src/icons/ZoomReset.tsx"() {
    init_IconWrapper();
    ZoomReset = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var EyeClose;
var init_EyeClose = __esm({
  "src/icons/EyeClose.tsx"() {
    init_IconWrapper();
    EyeClose = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var LightningOff;
var init_LightningOff = __esm({
  "src/icons/LightningOff.tsx"() {
    init_IconWrapper();
    LightningOff = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
...
var SwitchAlt;
var init_SwitchAlt = __esm({
  "src/icons/SwitchAlt.tsx"() {
    init_IconWrapper();
    SwitchAlt = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
      ...
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
          icon: /* @__PURE__ */ React36__namespace.createElement(
            ...
            /* @__PURE__ */ React36__namespace.createElement("path", { d: "M2.5 10a.5.5 0 100-1 .5.5 0 000 1z", fill: "currentColor" }),
            /* @__PURE__ */ React36__namespace.createElement(
              "path",
              {
                fillRule: "evenodd",
...
var PlayNext;
var init_PlayNext = __esm({
  "src/icons/PlayNext.tsx"() {
    init_IconWrapper();
    PlayNext = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var FastForward;
var init_FastForward = __esm({
  "src/icons/FastForward.tsx"() {
    init_IconWrapper();
    FastForward = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
...
var StopAlt;
var init_StopAlt = __esm({
  "src/icons/StopAlt.tsx"() {
    init_IconWrapper();
    StopAlt = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var SideBySide;
var init_SideBySide = __esm({
  "src/icons/SideBySide.tsx"() {
    init_IconWrapper();
    SideBySide = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var Stacked;
var init_Stacked = __esm({
  "src/icons/Stacked.tsx"() {
    init_IconWrapper();
    Stacked = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
      ...
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
          icon: /* @__PURE__ */ React36__namespace.createElement(
            ...
            /* @__PURE__ */ React36__namespace.createElement("g", { clipPath: "url(#prefix__clip0_1107_3492)", fill: "currentColor" }, /* @__PURE__ */ React36__namespace.createElement("path", { d: "M7.5.5a.5.5 0 00-1 0V2a.5.5 0 001 0V.5z" }), /* @__PURE__ */ React36__namespace.createElement(
              "path",
              {
                fillRule: "evenodd",
                clipRule: "evenodd",
            ...
            ), /* @__PURE__ */ React36__namespace.createElement("path", { d: "M7 11.5a.5.5 0 01.5.5v1.5a.5.5 0 01-1 0V12a.5.5 0 01.5-.5zM11.5 7a.5.5 0 01.5-.5h1.5a.5.5 0 010 1H12a.5.5 0 01-.5-.5zM.5 6.5a.5.5 0 000 1H2a.5.5 0 000-1H.5zM3.818 10.182a.5.5 0 010 .707l-1.06 1.06a.5.5 0 11-.708-.706l1.06-1.06a.5.5 0 01.708 0zM11.95 2.757a.5.5 0 10-.707-.707l-1.061 1.061a.5.5 0 10.707.707l1.06-1.06zM10.182 10.182a.5.5 0 01.707 0l1.06 1.06a.5.5 0 11-.706.708l-1.061-1.06a.5.5 0 010-.708zM2.757 2.05a.5.5 0 10-.707.707l1.06 1.061a.5.5 0 00.708-.707l-1.06-1.06z" })),
            /* @__PURE__ */ React36__namespace.createElement("defs", null, /* @__PURE__ */ React36__namespace.createElement("clipPath", { id: "prefix__clip0_1107_3492" }, /* @__PURE__ */ React36__namespace.createElement("path", { fill: "#fff", d: "M0 0h14v14H0z" })))
          ),
          ...restProps
        }
      );
      ...
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
          icon: /* @__PURE__ */ React36__namespace.createElement(
            ...
            /* @__PURE__ */ React36__namespace.createElement("g", { clipPath: "url(#prefix__clip0_1107_3493)" }, /* @__PURE__ */ React36__namespace.createElement(
              "path",
              {
                fillRule: "evenodd",
                clipRule: "evenodd",
            ...
            /* @__PURE__ */ React36__namespace.createElement("defs", null, /* @__PURE__ */ React36__namespace.createElement("clipPath", { id: "prefix__clip0_1107_3493" }, /* @__PURE__ */ React36__namespace.createElement(
              "path",
              {
                fill: "#fff",
...
var GraphLine;
var init_GraphLine = __esm({
  "src/icons/GraphLine.tsx"() {
    init_IconWrapper();
    GraphLine = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var GraphBar;
var init_GraphBar = __esm({
  "src/icons/GraphBar.tsx"() {
    init_IconWrapper();
    GraphBar = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var MenuReverse;
var init_MenuReverse = __esm({
  "src/icons/MenuReverse.tsx"() {
    init_IconWrapper();
    MenuReverse = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
...
var DocChart;
var init_DocChart = __esm({
  "src/icons/DocChart.tsx"() {
    init_IconWrapper();
    DocChart = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var DocList;
var init_DocList = __esm({
  "src/icons/DocList.tsx"() {
    init_IconWrapper();
    DocList = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var ListOrdered;
var init_ListOrdered = __esm({
  "src/icons/ListOrdered.tsx"() {
    init_IconWrapper();
    ListOrdered = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
...
var ListUnordered;
var init_ListUnordered = __esm({
  "src/icons/ListUnordered.tsx"() {
    init_IconWrapper();
    ListUnordered = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
...
var PullRequest;
var init_PullRequest = __esm({
  "src/icons/PullRequest.tsx"() {
    init_IconWrapper();
    PullRequest = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
      ...
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
          icon: /* @__PURE__ */ React36__namespace.createElement(
            ...
            /* @__PURE__ */ React36__namespace.createElement("g", { clipPath: "url(#prefix__clip0_1107_3497)", fill: "currentColor" }, /* @__PURE__ */ React36__namespace.createElement("path", { d: "M12.261 2.067c0 1.142-.89 2.068-1.988 2.068-1.099 0-1.99-.926-1.99-2.068C8.283.926 9.174 0 10.273 0c1.098 0 1.989.926 1.989 2.067zM3.978 6.6c0 1.142-.89 2.068-1.989 2.068C.891 8.668 0 7.742 0 6.601c0-1.142.89-2.068 1.989-2.068 1.099 0 1.989.926 1.989 2.068zM6.475 11.921A4.761 4.761 0 014.539 11a4.993 4.993 0 01-1.367-1.696 2.765 2.765 0 01-1.701.217 6.725 6.725 0 001.844 2.635 6.379 6.379 0 004.23 1.577 3.033 3.033 0 01-.582-1.728 4.767 4.767 0 01-.488-.083zM11.813 11.933c0 1.141-.89 2.067-1.989 2.067-1.098 0-1.989-.926-1.989-2.067 0-1.142.891-2.068 1.99-2.068 1.098 0 1.989.926 1.989 2.068zM12.592 11.173a6.926 6.926 0 001.402-3.913 6.964 6.964 0 00-1.076-4.023A2.952 2.952 0 0111.8 4.6c.398.78.592 1.656.564 2.539a5.213 5.213 0 01-.724 2.495c.466.396.8.935.952 1.54zM1.987 3.631c-.05 0-.101.002-.151.004C3.073 1.365 5.504.024 8.005.23a3.07 3.07 0 00-.603 1.676 4.707 4.707 0 00-2.206.596 4.919 4.919 0 00-1.7 1.576 2.79 2.79 0 00-1.509-.447z" })),
            /* @__PURE__ */ React36__namespace.createElement("defs", null, /* @__PURE__ */ React36__namespace.createElement("clipPath", { id: "prefix__clip0_1107_3497" }, /* @__PURE__ */ React36__namespace.createElement("path", { fill: "#fff", d: "M0 0h14v14H0z" })))
          ),
          ...restProps
        }
      );
      ...
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
          icon: /* @__PURE__ */ React36__namespace.createElement(
            ...
            /* @__PURE__ */ React36__namespace.createElement("g", { clipPath: "url(#prefix__clip0_1107_3496)" }, /* @__PURE__ */ React36__namespace.createElement(
              "path",
              {
                fillRule: "evenodd",
                clipRule: "evenodd",
            ...
            /* @__PURE__ */ React36__namespace.createElement("defs", null, /* @__PURE__ */ React36__namespace.createElement("clipPath", { id: "prefix__clip0_1107_3496" }, /* @__PURE__ */ React36__namespace.createElement("path", { fill: "#fff", d: "M0 0h14v14H0z" })))
          ),
          ...restProps
        }
      );
...
var AzureDevOps;
var init_AzureDevOps = __esm({
  "src/icons/AzureDevOps.tsx"() {
    init_IconWrapper();
    AzureDevOps = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
          icon: /* @__PURE__ */ React36__namespace.createElement(
            ...
            /* @__PURE__ */ React36__namespace.createElement("g", { clipPath: "url(#prefix__clip0_1107_3503)" }, /* @__PURE__ */ React36__namespace.createElement(
              "path",
              {
            ...
            /* @__PURE__ */ React36__namespace.createElement("defs", null, /* @__PURE__ */ React36__namespace.createElement("clipPath", { id: "prefix__clip0_1107_3503" }, /* @__PURE__ */ React36__namespace.createElement("path", { fill: "#fff", d: "M0 0h14v14H0z" })))
          ),
          ...restProps
        }
      );
...
var Chromatic;
var init_Chromatic = __esm({
  "src/icons/Chromatic.tsx"() {
    init_IconWrapper();
    Chromatic = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var ComponentDriven;
var init_ComponentDriven = __esm({
  "src/icons/ComponentDriven.tsx"() {
    init_IconWrapper();
    ComponentDriven = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
...
var GDrive;
var init_GDrive = __esm({
  "src/icons/GDrive.tsx"() {
    init_IconWrapper();
    GDrive = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var SidebarAlt;
var init_SidebarAlt = __esm({
  "src/icons/SidebarAlt.tsx"() {
    init_IconWrapper();
    SidebarAlt = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var SidebarAltToggle;
var init_SidebarAltToggle = __esm({
  "src/icons/SidebarAltToggle.tsx"() {
    init_IconWrapper();
    SidebarAltToggle = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
...
var SidebarToggle;
var init_SidebarToggle = __esm({
  "src/icons/SidebarToggle.tsx"() {
    init_IconWrapper();
    SidebarToggle = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
...
var BottomBar;
var init_BottomBar = __esm({
  "src/icons/BottomBar.tsx"() {
    init_IconWrapper();
    BottomBar = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var BottomBarToggle;
var init_BottomBarToggle = __esm({
  "src/icons/BottomBarToggle.tsx"() {
    init_IconWrapper();
    BottomBarToggle = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
...
var init_Devices = __esm({
  "src/groups/Devices.tsx"() {
    ...
    init_Sidebar();
    init_SidebarAlt();
    init_SidebarAltToggle();
    init_SidebarToggle();
    init_BottomBar();
    init_BottomBarToggle();
    init_CPU();
    init_Database();
    init_Memory();
    init_Structure();
...
var BatchDeny;
var init_BatchDeny = __esm({
  "src/icons/BatchDeny.tsx"() {
    init_IconWrapper();
    BatchDeny = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var BatchAccept;
var init_BatchAccept = __esm({
  "src/icons/BatchAccept.tsx"() {
    init_IconWrapper();
    BatchAccept = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
...
var CloseAlt;
var init_CloseAlt = __esm({
  "src/icons/CloseAlt.tsx"() {
    init_IconWrapper();
    CloseAlt = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var PinAlt;
var init_PinAlt = __esm({
  "src/icons/PinAlt.tsx"() {
    init_IconWrapper();
    PinAlt = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
          icon: /* @__PURE__ */ React36__namespace.createElement(
            ...
            /* @__PURE__ */ React36__namespace.createElement("g", { clipPath: "url(#prefix__clip0_1107_3502)" }, /* @__PURE__ */ React36__namespace.createElement(
              "path",
              {
                fillRule: "evenodd",
                clipRule: "evenodd",
            ...
            /* @__PURE__ */ React36__namespace.createElement("defs", null, /* @__PURE__ */ React36__namespace.createElement("clipPath", { id: "prefix__clip0_1107_3502" }, /* @__PURE__ */ React36__namespace.createElement("path", { fill: "#fff", d: "M0 0h14v14H0z" })))
          ),
          ...restProps
        }
      );
      ...
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
          icon: /* @__PURE__ */ React36__namespace.createElement(
            ...
            /* @__PURE__ */ React36__namespace.createElement("g", { clipPath: "url(#prefix__clip0_1107_3501)", fill: "currentColor" }, /* @__PURE__ */ React36__namespace.createElement("path", { d: "M13.44 4.44L9.56.56a1.5 1.5 0 00-2.12 0L7 1a1.415 1.415 0 000 2L5.707 4.293 6.414 5l2-2-.707-.707a.414.414 0 010-.586l.44-.44a.5.5 0 01.707 0l3.878 3.88a.5.5 0 010 .706l-.44.44a.414.414 0 01-.585 0L11 5.586l-2 2 .707.707L11 7a1.414 1.414 0 002 0l.44-.44a1.5 1.5 0 000-2.12zM.828 6.171a4 4 0 012.758-1.17l1 .999h-.93a3 3 0 00-2.12.878L1.414 7 7 12.586l.121-.122A3 3 0 008 10.343v-.929l1 1a4 4 0 01-1.172 2.757l-.474.475a.5.5 0 01-.708 0l-2.792-2.792-3 3a.5.5 0 01-.708-.708l3-3L.355 7.353a.5.5 0 010-.707l.474-.475zM1.854 1.146a.5.5 0 10-.708.708l11 11a.5.5 0 00.708-.708l-11-11z" })),
            /* @__PURE__ */ React36__namespace.createElement("defs", null, /* @__PURE__ */ React36__namespace.createElement("clipPath", { id: "prefix__clip0_1107_3501" }, /* @__PURE__ */ React36__namespace.createElement("path", { fill: "#fff", d: "M0 0h14v14H0z" })))
          ),
          ...restProps
        }
      );
...
var Passed;
var init_Passed = __esm({
  "src/icons/Passed.tsx"() {
    init_IconWrapper();
    Passed = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var CommentAdd;
var init_CommentAdd = __esm({
  "src/icons/CommentAdd.tsx"() {
    init_IconWrapper();
    CommentAdd = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var RequestChange;
var init_RequestChange = __esm({
  "src/icons/RequestChange.tsx"() {
    init_IconWrapper();
    RequestChange = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
      ...
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
          icon: /* @__PURE__ */ React36__namespace.createElement(
            ...
            /* @__PURE__ */ React36__namespace.createElement("g", { clipPath: "url(#prefix__clip0_1107_3614)", fill: "currentColor" }, /* @__PURE__ */ React36__namespace.createElement("path", { d: "M6.5 8.87a1 1 0 111 0v1.634a.5.5 0 01-1 0V8.87z" }), /* @__PURE__ */ React36__namespace.createElement(
              "path",
              {
                fillRule: "evenodd",
                clipRule: "evenodd",
            ...
            /* @__PURE__ */ React36__namespace.createElement("defs", null, /* @__PURE__ */ React36__namespace.createElement("clipPath", { id: "prefix__clip0_1107_3614" }, /* @__PURE__ */ React36__namespace.createElement("path", { fill: "#fff", d: "M0 0h14v14H0z" })))
          ),
          ...restProps
        }
      );
      ...
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
          icon: /* @__PURE__ */ React36__namespace.createElement(
            ...
            /* @__PURE__ */ React36__namespace.createElement("path", { d: "M11 4a1 1 0 11-2 0 1 1 0 012 0z", fill: "currentColor" }),
            /* @__PURE__ */ React36__namespace.createElement(
              "path",
              {
                fillRule: "evenodd",
...
var PointerDefault;
var init_PointerDefault = __esm({
  "src/icons/PointerDefault.tsx"() {
    init_IconWrapper();
    PointerDefault = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
...
var PointerHand;
var init_PointerHand = __esm({
  "src/icons/PointerHand.tsx"() {
    init_IconWrapper();
    PointerHand = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
...
var AlertAlt;
var init_AlertAlt = __esm({
  "src/icons/AlertAlt.tsx"() {
    init_IconWrapper();
    AlertAlt = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var ShareAlt;
var init_ShareAlt = __esm({
  "src/icons/ShareAlt.tsx"() {
    init_IconWrapper();
    ShareAlt = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var JumpTo;
var init_JumpTo = __esm({
  "src/icons/JumpTo.tsx"() {
    init_IconWrapper();
    JumpTo = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var CircleHollow;
var init_CircleHollow = __esm({
  "src/icons/CircleHollow.tsx"() {
    init_IconWrapper();
    CircleHollow = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
      ...
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
          icon: /* @__PURE__ */ React36__namespace.createElement(
            ...
            /* @__PURE__ */ React36__namespace.createElement("path", { d: "M14 7A7 7 0 110 7a7 7 0 0114 0z", fill: "currentColor" })
          ),
          ...restProps
        }
      );
...
var BookmarkHollow;
var init_BookmarkHollow = __esm({
  "src/icons/BookmarkHollow.tsx"() {
    init_IconWrapper();
    BookmarkHollow = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
      ...
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
          icon: /* @__PURE__ */ React36__namespace.createElement(
            ...
            /* @__PURE__ */ React36__namespace.createElement("g", { clipPath: "url(#prefix__clip0_1449_588)" }, /* @__PURE__ */ React36__namespace.createElement(
              "path",
              {
                fillRule: "evenodd",
                clipRule: "evenodd",
            ...
            /* @__PURE__ */ React36__namespace.createElement("defs", null, /* @__PURE__ */ React36__namespace.createElement("clipPath", { id: "prefix__clip0_1449_588" }, /* @__PURE__ */ React36__namespace.createElement("path", { fill: "#fff", d: "M0 0h14v14H0z" })))
          ),
          ...restProps
        }
      );
...
var HeartHollow;
var init_HeartHollow = __esm({
  "src/icons/HeartHollow.tsx"() {
    init_IconWrapper();
    HeartHollow = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
...
var StarHollow;
var init_StarHollow = __esm({
  "src/icons/StarHollow.tsx"() {
    init_IconWrapper();
    StarHollow = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var Basket;
var init_Basket = __esm({
  "src/icons/Basket.tsx"() {
    init_IconWrapper();
    Basket = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
      ...
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
          icon: /* @__PURE__ */ React36__namespace.createElement(
            ...
            /* @__PURE__ */ React36__namespace.createElement("path", { d: "M7.5 10.5a.5.5 0 11-1 0 .5.5 0 011 0z", fill: "currentColor" }),
            /* @__PURE__ */ React36__namespace.createElement(
              "path",
              {
                fillRule: "evenodd",
...
var CloudHollow;
var init_CloudHollow = __esm({
  "src/icons/CloudHollow.tsx"() {
    init_IconWrapper();
    CloudHollow = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
...
// src/groups/Communicate.tsx
var Communicate_exports = {};
__export(Communicate_exports, {
  Alert: () => Alert,
  AlertAlt: () => AlertAlt,
  Basket: () => Basket,
  Beaker: () => Beaker,
...
var ArrowSolidUp;
var init_ArrowSolidUp = __esm({
  "src/icons/ArrowSolidUp.tsx"() {
    init_IconWrapper();
    ArrowSolidUp = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
...
var ArrowSolidDown;
var init_ArrowSolidDown = __esm({
  "src/icons/ArrowSolidDown.tsx"() {
    init_IconWrapper();
    ArrowSolidDown = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
...
var ArrowSolidLeft;
var init_ArrowSolidLeft = __esm({
  "src/icons/ArrowSolidLeft.tsx"() {
    init_IconWrapper();
    ArrowSolidLeft = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
...
var ArrowSolidRight;
var init_ArrowSolidRight = __esm({
  "src/icons/ArrowSolidRight.tsx"() {
    init_IconWrapper();
...
var ExpandAlt;
var init_ExpandAlt = __esm({
  "src/icons/ExpandAlt.tsx"() {
    init_IconWrapper();
    ExpandAlt = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var Proceed;
var init_Proceed = __esm({
  "src/icons/Proceed.tsx"() {
    init_IconWrapper();
    Proceed = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
      ...
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
          icon: /* @__PURE__ */ React36__namespace.createElement(
            ...
            /* @__PURE__ */ React36__namespace.createElement("g", { clipPath: "url(#prefix__clip0_1107_3594)" }, /* @__PURE__ */ React36__namespace.createElement(
              "path",
              {
            ...
            /* @__PURE__ */ React36__namespace.createElement("defs", null, /* @__PURE__ */ React36__namespace.createElement("clipPath", { id: "prefix__clip0_1107_3594" }, /* @__PURE__ */ React36__namespace.createElement("path", { fill: "#fff", d: "M0 0h14v14H0z" })))
          ),
          ...restProps
        }
      );
...
// src/groups/Wayfinding.tsx
var Wayfinding_exports = {};
__export(Wayfinding_exports, {
  Admin: () => Admin,
  ArrowDown: () => ArrowDown,
  ArrowLeft: () => ArrowLeft,
...
var UserAlt;
var init_UserAlt = __esm({
  "src/icons/UserAlt.tsx"() {
    init_IconWrapper();
    UserAlt = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var FaceHappy;
var init_FaceHappy = __esm({
  "src/icons/FaceHappy.tsx"() {
    init_IconWrapper();
    FaceHappy = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
...
var FaceNeutral;
var init_FaceNeutral = __esm({
  "src/icons/FaceNeutral.tsx"() {
    init_IconWrapper();
    FaceNeutral = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
...
var FaceSad;
var init_FaceSad = __esm({
  "src/icons/FaceSad.tsx"() {
    init_IconWrapper();
    FaceSad = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
      ...
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
          icon: /* @__PURE__ */ React36__namespace.createElement(
            ...
            /* @__PURE__ */ React36__namespace.createElement("path", { d: "M7 4.5a1 1 0 100-2 1 1 0 000 2z", fill: "currentColor" }),
            /* @__PURE__ */ React36__namespace.createElement(
              "path",
              {
                fillRule: "evenodd",
...
var AccessibilityAlt;
var init_AccessibilityAlt = __esm({
  "src/icons/AccessibilityAlt.tsx"() {
    init_IconWrapper();
    AccessibilityAlt = (allProps) => {
      const { svgProps: props, ...restProps } = allProps;
      return /* @__PURE__ */ React36__namespace.createElement(
        IconWrapper,
        {
...
var init_People = __esm({
  "src/groups/People.tsx"() {
    ...
    init_FaceSad();
    init_Accessibility();
    init_AccessibilityAlt();
  }
});
var Fallback = ({ size }) => {
  return /* @__PURE__ */ React36__namespace.default.createElement("div", { style: { width: size, height: size } });
};

// src/utils/withSuspense.tsx
function withSuspense(WrappedComponent) {
  function ComponentWithSuspense(props) {
    return /* @__PURE__ */ React36__namespace.default.createElement(React36.Suspense, { fallback: /* @__PURE__ */ React36__namespace.default.createElement(Fallback, { ...props }) }, /* @__PURE__ */ React36__namespace.default.createElement(WrappedComponent, { ...props }));
  }
...
// src/index.ts
var Photo2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.Photo };
  })
);
var Component2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.Component };
  })
);
var Grid2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.Grid };
  })
);
var Outline2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.Outline };
  })
);
var PhotoDrag2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.PhotoDrag };
  })
);
var GridAlt2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.GridAlt };
  })
);
var Search2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.Search };
  })
);
var Zoom2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.Zoom };
  })
);
var ZoomOut2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.ZoomOut };
  })
);
var ZoomReset2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.ZoomReset };
  })
);
var Eye2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.Eye };
  })
);
var EyeClose2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.EyeClose };
  })
);
var Lightning2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.Lightning };
  })
);
var LightningOff2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.LightningOff };
  })
);
var Contrast2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.Contrast };
  })
);
var SwitchAlt2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.SwitchAlt };
  })
);
var Mirror2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.Mirror };
  })
);
var Grow2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.Grow };
  })
);
var PaintBrush2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.PaintBrush };
  })
);
var Ruler2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.Ruler };
  })
);
var Stop2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.Stop };
  })
);
var Camera2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.Camera };
  })
);
var Video2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.Video };
  })
);
var Speaker2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.Speaker };
  })
);
var Play2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.Play };
  })
);
var PlayBack2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.PlayBack };
  })
);
var PlayNext2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.PlayNext };
  })
);
var Rewind2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.Rewind };
  })
);
var FastForward2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.FastForward };
  })
);
var StopAlt2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.StopAlt };
  })
);
var SideBySide2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.SideBySide };
  })
);
var Stacked2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.Stacked };
  })
);
var Sun2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.Sun };
  })
);
var Moon2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Images(), Images_exports));
    return { default: m.Moon };
  })
);
var Book2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Documents(), Documents_exports));
    return { default: m.Book };
  })
);
var Document2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Documents(), Documents_exports));
    return { default: m.Document };
  })
);
var Copy2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Documents(), Documents_exports));
    return { default: m.Copy };
  })
);
var Category2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Documents(), Documents_exports));
    return { default: m.Category };
  })
);
var Folder2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Documents(), Documents_exports));
    return { default: m.Folder };
  })
);
var Print2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Documents(), Documents_exports));
    return { default: m.Print };
  })
);
var GraphLine2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Documents(), Documents_exports));
    return { default: m.GraphLine };
  })
);
var Calendar2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Documents(), Documents_exports));
    return { default: m.Calendar };
  })
);
var GraphBar2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Documents(), Documents_exports));
    return { default: m.GraphBar };
  })
);
var Menu2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Documents(), Documents_exports));
    return { default: m.Menu };
  })
);
var MenuReverse2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Documents(), Documents_exports));
    return { default: m.MenuReverse };
  })
);
var Filter2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Documents(), Documents_exports));
    return { default: m.Filter };
  })
);
var DocChart2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Documents(), Documents_exports));
    return { default: m.DocChart };
  })
);
var DocList2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Documents(), Documents_exports));
    return { default: m.DocList };
  })
);
var Markup2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Editing(), Editing_exports));
    return { default: m.Markup };
  })
);
var Bold2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Editing(), Editing_exports));
    return { default: m.Bold };
  })
);
var Italic2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Editing(), Editing_exports));
    return { default: m.Italic };
  })
);
var PaperClip2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Editing(), Editing_exports));
    return { default: m.PaperClip };
  })
);
var ListOrdered2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Editing(), Editing_exports));
    return { default: m.ListOrdered };
  })
);
var ListUnordered2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Editing(), Editing_exports));
    return { default: m.ListUnordered };
  })
);
var Paragraph2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Editing(), Editing_exports));
    return { default: m.Paragraph };
  })
);
var Markdown2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Editing(), Editing_exports));
    return { default: m.Markdown };
  })
);
var Repo2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Git(), Git_exports));
    return { default: m.Repo };
  })
);
var Commit2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Git(), Git_exports));
    return { default: m.Commit };
  })
);
var Branch2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Git(), Git_exports));
    return { default: m.Branch };
  })
);
var PullRequest2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Git(), Git_exports));
    return { default: m.PullRequest };
  })
);
var Merge2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Git(), Git_exports));
    return { default: m.Merge };
  })
);
var Apple2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_OS(), OS_exports));
    return { default: m.Apple };
  })
);
var Linux2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_OS(), OS_exports));
    return { default: m.Linux };
  })
);
var Ubuntu2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_OS(), OS_exports));
    return { default: m.Ubuntu };
  })
);
var Windows2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_OS(), OS_exports));
    return { default: m.Windows };
  })
);
var Chrome2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_OS(), OS_exports));
    return { default: m.Chrome };
  })
);
var Storybook2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Logos(), Logos_exports));
    return { default: m.Storybook };
  })
);
var AzureDevOps2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Logos(), Logos_exports));
    return { default: m.AzureDevOps };
  })
);
var Bitbucket2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Logos(), Logos_exports));
    return { default: m.Bitbucket };
  })
);
var Chromatic2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Logos(), Logos_exports));
    return { default: m.Chromatic };
  })
);
var ComponentDriven2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Logos(), Logos_exports));
    return { default: m.ComponentDriven };
  })
);
var Discord2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Logos(), Logos_exports));
    return { default: m.Discord };
  })
);
var Facebook2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Logos(), Logos_exports));
    return { default: m.Facebook };
  })
);
var Figma2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Logos(), Logos_exports));
    return { default: m.Figma };
  })
);
var GDrive2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Logos(), Logos_exports));
    return { default: m.GDrive };
  })
);
var Github2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Logos(), Logos_exports));
    return { default: m.Github };
  })
);
var Gitlab2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Logos(), Logos_exports));
    return { default: m.Gitlab };
  })
);
var Google2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Logos(), Logos_exports));
    return { default: m.Google };
  })
);
var Graphql2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Logos(), Logos_exports));
    return { default: m.Graphql };
  })
);
var Medium2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Logos(), Logos_exports));
    return { default: m.Medium };
  })
);
var Redux2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Logos(), Logos_exports));
    return { default: m.Redux };
  })
);
var Twitter2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Logos(), Logos_exports));
    return { default: m.Twitter };
  })
);
var Youtube2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Logos(), Logos_exports));
    return { default: m.Youtube };
  })
);
var VSCode2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Logos(), Logos_exports));
    return { default: m.VSCode };
  })
);
var Linkedin2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Logos(), Logos_exports));
    return { default: m.Linkedin };
  })
);
var Browser2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Devices(), Devices_exports));
    return { default: m.Browser };
  })
);
var Tablet2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Devices(), Devices_exports));
    return { default: m.Tablet };
  })
);
var Mobile2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Devices(), Devices_exports));
    return { default: m.Mobile };
  })
);
var Watch2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Devices(), Devices_exports));
    return { default: m.Watch };
  })
);
var Sidebar2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Devices(), Devices_exports));
    return { default: m.Sidebar };
  })
);
var SidebarAlt2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Devices(), Devices_exports));
    return { default: m.SidebarAlt };
  })
);
var SidebarAltToggle2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Devices(), Devices_exports));
    return { default: m.SidebarAltToggle };
  })
);
var SidebarToggle2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Devices(), Devices_exports));
    return { default: m.SidebarToggle };
  })
);
var BottomBar2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Devices(), Devices_exports));
    return { default: m.BottomBar };
  })
);
var BottomBarToggle2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Devices(), Devices_exports));
    return { default: m.BottomBarToggle };
  })
);
var CPU2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Devices(), Devices_exports));
    return { default: m.CPU };
  })
);
var Database2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Devices(), Devices_exports));
    return { default: m.Database };
  })
);
var Memory2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Devices(), Devices_exports));
    return { default: m.Memory };
  })
);
var Structure2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Devices(), Devices_exports));
    return { default: m.Structure };
  })
);
var Box2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Devices(), Devices_exports));
    return { default: m.Box };
  })
);
var Power2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Devices(), Devices_exports));
    return { default: m.Power };
  })
);
var Edit2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Edit };
  })
);
var Cog2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Cog };
  })
);
var Nut2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Nut };
  })
);
var Wrench2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Wrench };
  })
);
var Ellipsis2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Ellipsis };
  })
);
var Wand2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Wand };
  })
);
var Check2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Check };
  })
);
var Form2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Form };
  })
);
var BatchDeny2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.BatchDeny };
  })
);
var BatchAccept2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.BatchAccept };
  })
);
var Controls2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Controls };
  })
);
var Plus2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Plus };
  })
);
var CloseAlt2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.CloseAlt };
  })
);
var Cross2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Cross };
  })
);
var Trash2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Trash };
  })
);
var PinAlt2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.PinAlt };
  })
);
var Unpin2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Unpin };
  })
);
var Add2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Add };
  })
);
var Subtract2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Subtract };
  })
);
var Close2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Close };
  })
);
var Delete2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Delete };
  })
);
var Passed2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Passed };
  })
);
var Changed2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Changed };
  })
);
var Failed2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Failed };
  })
);
var Clear2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Clear };
  })
);
var Comment2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Comment };
  })
);
var CommentAdd2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.CommentAdd };
  })
);
var RequestChange2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.RequestChange };
  })
);
var Comments2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Comments };
  })
);
var Chat2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Chat };
  })
);
var Lock2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Lock };
  })
);
var Unlock2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Unlock };
  })
);
var Key2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Key };
  })
);
var Outbox2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Outbox };
  })
);
var Credit2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Credit };
  })
);
var Button2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Button };
  })
);
var Type2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Type };
  })
);
var PointerDefault2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.PointerDefault };
  })
);
var PointerHand2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.PointerHand };
  })
);
var Command2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_CRUD(), CRUD_exports));
    return { default: m.Command };
  })
);
var Info2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Info };
  })
);
var Question2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Question };
  })
);
var Support2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Support };
  })
);
var Alert2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Alert };
  })
);
var AlertAlt2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.AlertAlt };
  })
);
var Email2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Email };
  })
);
var Phone2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Phone };
  })
);
var Link2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Link };
  })
);
var LinkBroken2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.LinkBroken };
  })
);
var Bell2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Bell };
  })
);
var RSS2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.RSS };
  })
);
var ShareAlt2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.ShareAlt };
  })
);
var Share2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Share };
  })
);
var JumpTo2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.JumpTo };
  })
);
var CircleHollow2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.CircleHollow };
  })
);
var Circle2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Circle };
  })
);
var BookmarkHollow2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.BookmarkHollow };
  })
);
var Bookmark2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Bookmark };
  })
);
var Diamond2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Diamond };
  })
);
var HeartHollow2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.HeartHollow };
  })
);
var Heart2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Heart };
  })
);
var StarHollow2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.StarHollow };
  })
);
var Star2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Star };
  })
);
var Certificate2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Certificate };
  })
);
var Verified2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Verified };
  })
);
var ThumbsUp2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.ThumbsUp };
  })
);
var Shield2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Shield };
  })
);
var Basket2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Basket };
  })
);
var Beaker2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Beaker };
  })
);
var Hourglass2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Hourglass };
  })
);
var Flag2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Flag };
  })
);
var CloudHollow2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.CloudHollow };
  })
);
var Cloud2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Cloud };
  })
);
var Sticker2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Communicate(), Communicate_exports));
    return { default: m.Sticker };
  })
);
var ChevronUp2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.ChevronUp };
  })
);
var ChevronDown2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.ChevronDown };
  })
);
var ChevronLeft2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.ChevronLeft };
  })
);
var ChevronRight2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.ChevronRight };
  })
);
var ArrowUp2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.ArrowUp };
  })
);
var ArrowDown2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.ArrowDown };
  })
);
var ArrowLeft2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.ArrowLeft };
  })
);
var ArrowRight2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.ArrowRight };
  })
);
var ArrowSolidUp2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.ArrowSolidUp };
  })
);
var ArrowSolidDown2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.ArrowSolidDown };
  })
);
var ArrowSolidLeft2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.ArrowSolidLeft };
  })
);
var ArrowSolidRight2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.ArrowSolidRight };
  })
);
var ExpandAlt2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.ExpandAlt };
  })
);
var Collapse2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Collapse };
  })
);
var Expand2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Expand };
  })
);
var Unfold2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Unfold };
  })
);
var Transfer2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Transfer };
  })
);
var Redirect2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Redirect };
  })
);
var Undo2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Undo };
  })
);
var Reply2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Reply };
  })
);
var Sync2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Sync };
  })
);
var Upload2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Upload };
  })
);
var Download2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Download };
  })
);
var Back2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Back };
  })
);
var Proceed2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Proceed };
  })
);
var Refresh2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Refresh };
  })
);
var Globe2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Globe };
  })
);
var Compass2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Compass };
  })
);
var Location2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Location };
  })
);
var Pin2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Pin };
  })
);
var Time2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Time };
  })
);
var Dashboard2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Dashboard };
  })
);
var Timer2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Timer };
  })
);
var Home2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Home };
  })
);
var Admin2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Admin };
  })
);
var Direction2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_Wayfinding(), Wayfinding_exports));
    return { default: m.Direction };
  })
);
var User2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_People(), People_exports));
    return { default: m.User };
  })
);
var UserAlt2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_People(), People_exports));
    return { default: m.UserAlt };
  })
);
var UserAdd2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_People(), People_exports));
    return { default: m.UserAdd };
  })
);
var Users2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_People(), People_exports));
    return { default: m.Users };
  })
);
var Profile2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_People(), People_exports));
    return { default: m.Profile };
  })
);
var FaceHappy2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_People(), People_exports));
    return { default: m.FaceHappy };
  })
);
var FaceNeutral2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_People(), People_exports));
    return { default: m.FaceNeutral };
  })
);
var FaceSad2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_People(), People_exports));
    return { default: m.FaceSad };
  })
);
var Accessibility2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_People(), People_exports));
    return { default: m.Accessibility };
  })
);
var AccessibilityAlt2 = withSuspense(
  React36.lazy(async () => {
    const m = await Promise.resolve().then(() => (init_People(), People_exports));
...
exports.Accessibility = Accessibility2;
exports.AccessibilityAlt = AccessibilityAlt2;
exports.Add = Add2;
exports.Admin = Admin2;
exports.Alert = Alert2;
exports.AlertAlt = AlertAlt2;
exports.Apple = Apple2;
exports.ArrowDown = ArrowDown2;
exports.ArrowLeft = ArrowLeft2;
exports.ArrowRight = ArrowRight2;
exports.ArrowSolidDown = ArrowSolidDown2;
exports.ArrowSolidLeft = ArrowSolidLeft2;
exports.ArrowSolidRight = ArrowSolidRight2;
exports.ArrowSolidUp = ArrowSolidUp2;
exports.ArrowUp = ArrowUp2;
exports.AzureDevOps = AzureDevOps2;
exports.Back = Back2;
exports.Basket = Basket2;
exports.BatchAccept = BatchAccept2;
exports.BatchDeny = BatchDeny2;
exports.Beaker = Beaker2;
exports.Bell = Bell2;
exports.Bitbucket = Bitbucket2;
exports.Bold = Bold2;
exports.Book = Book2;
exports.Bookmark = Bookmark2;
exports.BookmarkHollow = BookmarkHollow2;
exports.BottomBar = BottomBar2;
exports.BottomBarToggle = BottomBarToggle2;
exports.Box = Box2;
exports.Branch = Branch2;
exports.Browser = Browser2;
exports.Button = Button2;
exports.CPU = CPU2;
exports.Calendar = Calendar2;
exports.Camera = Camera2;
exports.Category = Category2;
exports.Certificate = Certificate2;
exports.Changed = Changed2;
exports.Chat = Chat2;
exports.Check = Check2;
exports.ChevronDown = ChevronDown2;
exports.ChevronLeft = ChevronLeft2;
exports.ChevronRight = ChevronRight2;
exports.ChevronUp = ChevronUp2;
exports.Chromatic = Chromatic2;
exports.Chrome = Chrome2;
exports.Circle = Circle2;
exports.CircleHollow = CircleHollow2;
exports.Clear = Clear2;
exports.Close = Close2;
exports.CloseAlt = CloseAlt2;
exports.Cloud = Cloud2;
exports.CloudHollow = CloudHollow2;
exports.Cog = Cog2;
exports.Collapse = Collapse2;
exports.Command = Command2;
exports.Comment = Comment2;
exports.CommentAdd = CommentAdd2;
exports.Comments = Comments2;
exports.Commit = Commit2;
exports.Compass = Compass2;
exports.Component = Component2;
exports.ComponentDriven = ComponentDriven2;
exports.Contrast = Contrast2;
exports.Controls = Controls2;
exports.Copy = Copy2;
exports.Credit = Credit2;
exports.Cross = Cross2;
exports.Dashboard = Dashboard2;
exports.Database = Database2;
exports.Delete = Delete2;
exports.Diamond = Diamond2;
exports.Direction = Direction2;
exports.Discord = Discord2;
exports.DocChart = DocChart2;
exports.DocList = DocList2;
exports.Document = Document2;
exports.Download = Download2;
exports.Edit = Edit2;
exports.Ellipsis = Ellipsis2;
exports.Email = Email2;
exports.Expand = Expand2;
exports.ExpandAlt = ExpandAlt2;
exports.Eye = Eye2;
exports.EyeClose = EyeClose2;
exports.FaceHappy = FaceHappy2;
exports.FaceNeutral = FaceNeutral2;
exports.FaceSad = FaceSad2;
exports.Facebook = Facebook2;
exports.Failed = Failed2;
exports.FastForward = FastForward2;
exports.Figma = Figma2;
...
exports.Gitlab = Gitlab2;
exports.Globe = Globe2;
exports.Google = Google2;
exports.GraphBar = GraphBar2;
exports.GraphLine = GraphLine2;
exports.Graphql = Graphql2;
exports.Grid = Grid2;
exports.GridAlt = GridAlt2;
exports.Grow = Grow2;
exports.Heart = Heart2;
exports.HeartHollow = HeartHollow2;
exports.Home = Home2;
exports.Hourglass = Hourglass2;
exports.Info = Info2;
exports.Italic = Italic2;
exports.JumpTo = JumpTo2;
exports.Key = Key2;
exports.Lightning = Lightning2;
exports.LightningOff = LightningOff2;
exports.Link = Link2;
exports.LinkBroken = LinkBroken2;
exports.Linkedin = Linkedin2;
exports.Linux = Linux2;
exports.ListOrdered = ListOrdered2;
exports.ListUnordered = ListUnordered2;
exports.Location = Location2;
exports.Lock = Lock2;
exports.Markdown = Markdown2;
exports.Markup = Markup2;
exports.Medium = Medium2;
exports.Memory = Memory2;
exports.Menu = Menu2;
exports.MenuReverse = MenuReverse2;
exports.Merge = Merge2;
exports.Mirror = Mirror2;
exports.Mobile = Mobile2;
exports.Moon = Moon2;
exports.Nut = Nut2;
exports.Outbox = Outbox2;
exports.Outline = Outline2;
exports.PaintBrush = PaintBrush2;
exports.PaperClip = PaperClip2;
exports.Paragraph = Paragraph2;
exports.Passed = Passed2;
exports.Phone = Phone2;
exports.Photo = Photo2;
exports.PhotoDrag = PhotoDrag2;
exports.Pin = Pin2;
exports.PinAlt = PinAlt2;
exports.Play = Play2;
exports.PlayBack = PlayBack2;
exports.PlayNext = PlayNext2;
exports.Plus = Plus2;
exports.PointerDefault = PointerDefault2;
exports.PointerHand = PointerHand2;
exports.Power = Power2;
exports.Print = Print2;
exports.Proceed = Proceed2;
exports.Profile = Profile2;
exports.PullRequest = PullRequest2;
exports.Question = Question2;
exports.RSS = RSS2;
exports.Redirect = Redirect2;
exports.Redux = Redux2;
exports.Refresh = Refresh2;
exports.Reply = Reply2;
exports.Repo = Repo2;
exports.RequestChange = RequestChange2;
exports.Rewind = Rewind2;
exports.Ruler = Ruler2;
exports.Search = Search2;
exports.Share = Share2;
exports.ShareAlt = ShareAlt2;
exports.Shield = Shield2;
exports.SideBySide = SideBySide2;
exports.Sidebar = Sidebar2;
exports.SidebarAlt = SidebarAlt2;
exports.SidebarAltToggle = SidebarAltToggle2;
exports.SidebarToggle = SidebarToggle2;
exports.Speaker = Speaker2;
exports.Stacked = Stacked2;
exports.Star = Star2;
exports.StarHollow = StarHollow2;
exports.Sticker = Sticker2;
exports.Stop = Stop2;
exports.StopAlt = StopAlt2;
exports.Storybook = Storybook2;
exports.Structure = Structure2;
exports.Subtract = Subtract2;
exports.Sun = Sun2;
exports.Support = Support2;
exports.SwitchAlt = SwitchAlt2;
exports.Sync = Sync2;
exports.Tablet = Tablet2;
exports.ThumbsUp = ThumbsUp2;
exports.Time = Time2;
exports.Timer = Timer2;
exports.Transfer = Transfer2;
exports.Trash = Trash2;
exports.Twitter = Twitter2;
exports.Type = Type2;
exports.Ubuntu = Ubuntu2;
exports.Undo = Undo2;
exports.Unfold = Unfold2;
exports.Unlock = Unlock2;
exports.Unpin = Unpin2;
exports.Upload = Upload2;
exports.User = User2;
exports.UserAdd = UserAdd2;
exports.UserAlt = UserAlt2;
exports.Users = Users2;
exports.VSCode = VSCode2;
exports.Verified = Verified2;
exports.Video = Video2;
exports.Wand = Wand2;
exports.Watch = Watch2;
exports.Windows = Windows2;
exports.Wrench = Wrench2;
exports.Youtube = Youtube2;
exports.Zoom = Zoom2;
exports.ZoomOut = ZoomOut2;
exports.ZoomReset = ZoomReset2;
