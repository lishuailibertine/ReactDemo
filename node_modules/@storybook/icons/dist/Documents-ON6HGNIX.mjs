import { IconWrapper } from './chunk-MSDTXLE7.mjs';
...
export { Book, Calendar, Category, Copy, DocChart, DocList, Document, Filter, Folder, GraphBar, GraphLine, Menu, MenuReverse, Print };
